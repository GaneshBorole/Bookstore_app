...
function Navbar() {
  ...
  useEffect(() => {
    const element = document.documentElement; // Select root element (html)
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
        sticky?"sticky-navbar shadow-md bg-base-200 duration-300 dark:bg-slate-600 dark:text-white tarnsition-all ease-in-out ":""
